...
async function creatNewArray() {
    let myApi = await fetch(`${API}`, {})
    let jsonApi = await myApi.json()
    let UsersArray = []
    for (const usersJson of jsonApi) {
        let apiUsers = new usersFromApi();
        apiUsers.index = usersJson.index;
        apiUsers.age = usersJson.age;
        apiUsers.picture = usersJson.picture;
        apiUsers.phone = usersJson.phone;
        apiUsers.email = usersJson.email;
        apiUsers.name = usersJson.name;
        UsersArray.push(apiUsers)
    }
    return UsersArray
            ...
            <div class="main-login main-center">
                ...
                <form class="" method="post" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-apiUsers fa" aria-hidden="true"></i></span>
